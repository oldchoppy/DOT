...
void setup() {
  ...
  servo1.write(80);//setpoint is 90
  servo2.attach(servo2_pin);
  servo2.write(10);//setpoint is 0
  servo3.attach(servo3_pin);
  servo3.write(45);//setpoint is 90
  servo4.attach(servo4_pin);
  servo4.write(100);//setpoint is 90
  servo5.attach(servo5_pin);
  servo5.write(90);//setpoint is 90
